				...
				<div class="col-lg-10">
					<div class="card alert">
						<div class="card-header">
							<h4 class="mb">
								<a href="${pageContext.request.contextPath }/Order?method=OrderQueryAllAdmin"><i class="ti-arrow-circle-left"></i> </a>
								订单表
							</h4>
						...
						<div class="card-body">
							<table class="table table-responsive table-hover ">
								...
								<c:if test="${!empty user}">
									<tr>
										<td style="text-align: center;display: none;" class="color-success">${user.id}</td>
										<td style="text-align: center;" class="color-success">${user.userid}</td>
										<td style="text-align: center;display: none;" class="color-success">${user.accountnumber}</td>
										<td style="text-align: center;display: none;" class="color-success">${user.pwd}</td>
										<td style="text-align: center;" class="color-success">${user.username}</td>
										<td style="text-align: center;" class="color-success">${user.address}</td>
										<td style="text-align: center;" class="color-success">${user.phone}</td>
										<td>
