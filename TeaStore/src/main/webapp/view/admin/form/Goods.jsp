                ...
                <div class="card-body">
                    ...
                    <div class="input-states">
                        ...
                        <c:if test="${goods1==null }">
                            ...
                            <form action="${pageContext.request.contextPath }/Goods?method=AddGoods" method="post" class="form-horizontal">

                                <div class="form-group has-success" style="display: none">
                                    <div class="row">
                                        <label class="col-sm-3 control-label">商品条码</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="商品条码" name="goodscode" value="${goods1.goodscode}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-success">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="商品名称" name="goodsname" value="${goods1.goodsname}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-success">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="商品类别" name="goodstype" value="${goods1.goodstype}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-success">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  class="form-control" placeholder="商品规格" name="goodspecs" value="${goods1.goodspecs}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-success">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="商品品牌" name="goodsbrand" value="${goods1.goodsbrand}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-success" style="display: none">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  class="form-control" placeholder="商品图片" name="goodspicture" value="${goods1.goodspicture}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-success">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  class="form-control" placeholder="销售价格" name="saleprice" value="${goods1.saleprice}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-success">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  class="form-control" placeholder="库存量" name="count" value="${goods1.count}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-success">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="上架状态" name="isonsale" value="${goods1.isonsale}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-success">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="商品描述" name="goodsdescribe" value="${goods1.goodsdescribe}">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <c:if test="${goods1!=null }">
                            ...
                            <form action="${pageContext.request.contextPath }/Goods?method=updateGoods&id=${goods1.id}&count=2" method="post" class="form-horizontal">
                                ...
                                <div class="form-group has-success">
                                    <div class="row">
                                        <label class="col-sm-3 control-label">库存量</label>
                                        <div class="col-sm-9">
                                            <input type="text"  class="form-control" placeholder="库存量" name="Goodscount" value="${goods1.count}">
                                        </div>
                                    </div>
                                </div>
